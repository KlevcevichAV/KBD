...
public class ControllerSearchListTechnicPerson {
    ...
    private void createTable() throws SQLException, ClassNotFoundException {
        ...
        ObservableList<Technics> test = FXCollections.observableArrayList(Controller.getDataBase().searchTechnicPerson(Constant.intToDate(Integer.parseInt(dayField.getText()),Integer.parseInt(MonthField.getText()), Integer.parseInt(yearField.getText())),fullNameField.getText(), positionField.getText()));
        table.setItems(test);
